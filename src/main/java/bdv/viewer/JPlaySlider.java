...
public class JPlaySlider extends JPanel
{
	...
	public JPlaySlider()
	{
		...
		for ( final JLabel anySliderLabel : sliderLabels )
		{
	...
	private MouseAdapter onClickDo( final Runnable action )
	{
		return new MouseAdapter()
		{
			...
			public void mouseClicked( final MouseEvent e )
			{
				...
				for ( final ChangeListener anyChangeListener : playSlider.getChangeListeners() )
				{
	...
	private Rectangle getSliderTrackRect()
	{
		...
		if ( fallbackNeeded ) { return playSlider.getVisibleRect(); }
		...
		try
		{
			...
			if ( null == result ) { return playSlider.getVisibleRect(); }
