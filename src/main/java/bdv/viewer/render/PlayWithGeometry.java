...
public class PlayWithGeometry
{
	...
	{
		final ArrayList< long[] > l1 = new Prefetcher4().scan( sourceToScreen, cellDimensions, dimensions, screenInterval, cellsRandomAccess );
		final ArrayList< long[] > l2 = new Prefetcher5().scan( sourceToScreen, cellDimensions, dimensions, screenInterval, cellsRandomAccess );
